"""
Simple Soccer Simulation with Visualization
...
class Visualizer:
    ...
    def update(self, frame):
        ...
        self.ax.text(0, PITCH_WIDTH/2 + 0.3, 
                    f'Algorithm: {self.sim.decision_algorithm} | Time: {self.sim.time} | Goals: {self.sim.goals_scored} | Ball Speed: {ball_speed:.2f} | Spin: {self.sim.ball.spin:.2f}',
...
def main():
    print("Soccer Simulation - Decision Tree Evolution")
    print("=" * 50)
