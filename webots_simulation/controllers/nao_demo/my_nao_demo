...
static void load_motion_files() {
  hand_wave = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/HandWave.motion");
  forwards = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/Forwards50.motion");
  backwards = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/Backwards.motion");
  side_step_left = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/SideStepLeft.motion");
  side_step_right = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/SideStepRight.motion");
  turn_left_60 = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/TurnLeft60.motion");
  turn_right_60 = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/TurnRight60.motion");
  tai_chi = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/TaiChi.motion");
  wipe_forehead = wbu_motion_new("D:/Webots/projects/robots/softbank/nao/motions/WipeForehead.motion");
}
